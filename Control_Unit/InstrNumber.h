    ...
    void instruction() {
        while (1){
            ...
            if(opcode_6to2.read()==24){
                if(func3.read()==0){
                    number.write(32);     //BRANCH BEQ
                }
                if(func3.read()==1){
                    number.write(36);     //BRANCH BNE
                }
                if(func3.read()==4){
                    number.write(40);      //BRANCH BLT
                }
                if(func3.read()==5){
                    number.write(44);      //BRANCH BGE
                }
                if(func3.read()==6){
                    number.write(48);      //BRANCH BLTU
                }
                if(func3.read()==7){
                    number.write(52);      //BRANCH BGEU
                }
            }
