...
int sc_main (int argc, char *argv[]) {
    ...
    sc_signal<bool>     waitMEM("waitMEM");
    sc_signal<bool>     memBusy("memBusy");
    ...
    sc_signal<sc_lv<32>>    rdata_o;
    sc_signal<sc_lv<1>>     selRD;
    muxRD.i0(ALU_value);
    muxRD.i1(rdata_o);
    muxRD.sel(selRD);
    muxRD.res(rd_value);
    ...
    //---------------------------------------- IR ------------------------------------------------------
    IR IR("IR");
    sc_signal<sc_lv<32>>    rdata_unbuff_o;
    sc_signal<bool>         wIR;
    ...
    sc_signal<sc_lv<30>>    PADDR30;
    sc_signal<sc_lv<32>>    PADDR32;
    sc_signal<sc_lv<2>>     PSEL;
    sc_signal<sc_lv<1>>     PREQ;
    sc_signal<sc_lv<1>>     trigger;
    sc_signal<sc_lv<1>>     PREADY;
    sc_signal<sc_lv<1>>     unaligned;
    sc_signal<bool>         condition;
    sc_signal<sc_lv<1>>     unaligned_or_notPREADY;
    sc_signal<sc_lv<1>>     notPREADY;

    sc_signal<sc_lv<1>>     op1;
    sc_signal<sc_lv<1>>     op2;
    sc_signal<sc_lv<1>>     first_cycle;
    sc_signal<sc_lv<2>>     busy_sel;
    sc_signal<sc_lv<1>>     preq_sel;
    ...
    sc_signal<sc_lv<4>>     muxbytestrb_to_PSTRB;
    ...
    sc_signal<sc_lv<64>>     reg_to_mux64;
    ...
    sc_signal<sc_lv<32>>     regtomux64_31to0;
    sc_signal<sc_lv<32>>     regtomux_63to32;
    sc_signal<sc_lv<32>>     muxwdata_to_PWDATA;
    ...
    sc_signal<sc_lv<32>>     wdata_31to0;
    ...
    sc_signal<sc_lv<30>>    WORDADDR;
    sc_signal<sc_lv<30>>    regtomuxPADDR;
    regPADDR.d(WORDADDR);
    ...
    sc_signal<sc_lv<30>>    plustomux;
    sc_signal<sc_lv<1>>     one;
    plus.one(one);
    ...
    sc_signal<sc_lv<64>>    out8rtomux;
    sc_signal<sc_lv<64>>    out16rtomux;
    sc_signal<sc_lv<64>>    out24rtomux;
    sc_signal<sc_lv<64>>    RDATA64;
    sc_signal<sc_lv<32>>    RDATA64_31to0;
    sc_signal<sc_lv<64>>    RDATA64A;
    sc_signal<sc_lv<64>>    RDATA64B;
    sc_signal<sc_lv<32>>    regtoRDATA64B;
    sc_signal<sc_lv<32>>    out8_31to0;
    sc_signal<sc_lv<32>>    out16_31to0;
    sc_signal<sc_lv<32>>    out24_31to0;
    sc_signal<sc_lv<32>>    muxtoextends;
    sc_signal<sc_lv<16>>    muxtoextends_15to0;
    sc_signal<sc_lv<8>>     muxtoextends_7to0;
    ...
    sc_signal<sc_lv<1>>     unsigned_i;
    sc_signal<sc_lv<32>>    byteext_out;
    ...
    sc_signal<sc_lv<32>>     halfext_out;
    ...
    sc_signal<sc_lv<32>>    muxSIZEtoreg;
